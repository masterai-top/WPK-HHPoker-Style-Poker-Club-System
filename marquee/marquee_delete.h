#ifndef __MARQUEE_DELETE_H__
#define __MARQUEE_DELETE_H__
class MarqueeDeleteRequest
{
public:
	MarqueeDeleteRequest(const string& json) {
...
class MarqueeDeleteResponse
{
public:
	MarqueeDeleteResponse(const string& json) {
		this->Deserialize(json);
	}
	template <typename Writer>
	void Serialize(Writer& writer) const {
